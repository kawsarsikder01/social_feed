...
const suggestedPeople: SuggestedPerson[] = [
    { image: 'assets/images/people1.png', name: 'Steve Jobs', role: 'CEO of Apple' },
    { image: 'assets/images/people2.png', name: 'Ryan Roslansky', role: 'CEO of Linkedin' },
    { image: 'assets/images/people3.png', name: 'Dylan Field', role: 'CEO of Figma' },
];
                                            ...
                                            <a className="_left_inner_event_card_link" href="event-single.html">
                                                <div className="_left_inner_event_card">
                                                    ...
                                                    <div className="_left_inner_event_bottom">
                                                        <p className="_left_iner_event_bottom">17 People Going</p> <button type="button" className="_left_iner_event_bottom_link">Going</button>
                                                    </div>
                                                </div>
                                            </a>
                                            <a className="_left_inner_event_card_link" href="event-single.html">
